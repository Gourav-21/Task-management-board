...
export function KanbanBoard({tasks, setTasks, update }: {tasks: Task[],update:(id: string, newData:Task, remove?: boolean) => void, setTasks: React.Dispatch<React.SetStateAction<Task[]>>}) {
      ...
      {"document" in window &&
        createPortal(
          <DragOverlay>
            ...
            {activeTask && <TaskCard task={activeTask} update={update} isOverlay />}
          </DragOverlay>,
          document.body
        )}
    </DndContext>
